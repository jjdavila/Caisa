...
<div id="content" class="span10">
    ...
    <div class="box span12">
        <div class="box-header">
            <h2><i class="icon-edit"></i>Acumulados de adicion de salarios</h2>
            <div class="box-icon">
                        ...
                        <div class="row-fluid">            
                            ...
                            <div class="span6">
                                <fieldset>
                                     <h3>.</h3>
                                    <div class="control-group">
                                        <label class="control-label" for="txtAnnoMes">Año - Mes aplica</label>
                                        <div class="controls">
                                            <input type="text" id="txtAnnoMes">
					...
					<div class="box-content">
						<table class="table table-bordered">
							  ...
							  <tbody>
                                ...
                                <div class="box span6">
                                    <div class="box-header">
                                        <h2><i class="icon-align-justify"></i><span class="break"></span>Calculos x Mes</h2>
                                        <div class="box-icon">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="cmbAcumulaxiimes">Acumula para el XII mes?</label>
                                        <div class="controls">
                                            <select id="cmbAcumulaxiimes" data-rel="chosen">
                                                <option>SI</option>
                                                <option>NO</option>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" for="txtLiquidacion">Liquidacion?</label>
                                        <div class="controls">
                                            <select id="txtLiquidacion" data-rel="chosen">
                                                <option>SI</option>
                                                <option>NO</option>
