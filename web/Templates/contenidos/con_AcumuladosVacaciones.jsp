			...
			<div id="content" class="span10">
              ...
              <div class="row-fluid">	
				<div class="box span12">
					<div class="box-header">
						<h2><i class="icon-edit"></i>Acumulados Vacaciones</h2>
						<div class="box-icon">
			...
			<!-- end: Content -->
						...
						<!-- start: Content de tablas  -->
			<div id="content" class="span10">
			<div class="row-fluid">	
				<div class="box span6">
					<div class="box-header">
						<h2><i class="icon-align-justify"></i><span class="break"></span>Actual</h2>
						<div class="box-icon">
			...
			<div class="box span6">
					<div class="box-header">
						<h2><i class="icon-align-justify"></i><span class="break"></span>Vencidos</h2>
						<div class="box-icon">
