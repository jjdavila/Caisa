...
<div id="content" class="span10">
    ...
    <div class="row-fluid">
        ...
        <div class="box span12">
            <div class="box-header">
                <h2><i class="icon-edit"></i>Inform x rata x horas</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal">
                    <div class="row-fluid">            
                        <div class="span6">
                            <h3>Este informa brinda al usuario un listado de todos los Salarios x Periodos (fijo x horas)de los empleados.</h3>
                            <fieldset>  
