...
<html lang="en">
    <head>
        ...
        <meta name="keyword" content="planilla caisa, control de personal">
        <!-- end: Meta -->
    ...
    <template:insert template="/Templates/template.jsp">
        ...
        <template:put name="contenido" content="/Templates/contenidos/con_mantenimiento_general.jsp"/>
    ...
    <script src="js/caisa/mantenimiento.js"></script>
    <!-- end: JavaScript-->
